...
def main():
    ...
    kymo_filename_rel = 'data/image data/image_data_example 30nM DNAp + trx  + 625uM dNTPs.tdms'
    ...
    trace_file_rel = 'results/OTdata_example_30nM DNAp + trx  + 625uM dNTPs-cycle#01-processedData.xlsx'
    ...
    plot_output_path = os.path.join(results_dir, plot_filename)
    ...
    intensity_filtered_path = os.path.join(results_dir, f"{file_stem}-cycle{kymo_cycle}-Intensity_along_DNAp-filtered.txt")
    ...
    output_dir_steps = os.path.join(results_dir, 'stepfinding_results')
    ...
    # Load file
    file_path_rel = 'results/OTdata_example_30nM DNAp + trx  + 625uM dNTPs-cycle#01-processedData.xlsx'
    file_path = os.path.join(project_root, file_path_rel)

    # Create Output Directory and Filename Stem
    folder_save = os.path.join(results_dir, 'ChangePoints_Results')
