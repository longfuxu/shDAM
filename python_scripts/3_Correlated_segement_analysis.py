...
def main():
    ...
    # project_root/
    #  |- python_scripts/ (this script)
    #  |- example_dataset/
    script_dir = os.path.dirname(os.path.realpath(__file__))
    project_root = os.path.join(script_dir, '..')

    default_cor_file = os.path.join(project_root, 'example_dataset/image data/ChangePoints_Results/OTdata_example_30nM DNAp + trx  + 625uM dNTPs-cycle#01-processedData-correlated_analysis.xlsx')
    default_cor_file2 = os.path.join(project_root, 'example_dataset/image data/results/image_data_example 30nM DNAp + trx  + 625uM dNTPs-cycle#1-Intensity_along_DNAp-filtered.txt')
    default_cor_file3 = os.path.join(project_root, 'example_dataset/image data/stepfinding_results/image_data_example 30nM DNAp + trx  + 625uM dNTPs-cycle#1-Intensity_along_DNAp-filtered_fit_trace.csv')
    default_output_dir = os.path.join(project_root, 'example_dataset/final_analysis')
