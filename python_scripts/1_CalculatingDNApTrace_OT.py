...
filename_rel = 'example_dataset/force data/OTdata_example_30nM DNAp + trx  + 625uM dNTPs.tdms'
filename = os.path.join(project_root, filename_rel)

# Create results directory if it doesn't exist
results_dir_rel = 'example_dataset/force data/results'
results_dir = os.path.join(project_root, results_dir_rel)
